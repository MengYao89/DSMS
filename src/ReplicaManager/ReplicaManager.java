...
public class ReplicaManager {
	...
	public static int LEADER_ELECTION_PORT = 5003;
	public static int BROAD_CAST_PORT = 5004;
	public static int HEARTBEAT_PORT1 = 5005;
	public static int HEARTBEAT_PORT2 = 5006;

	public static void main(String[] args) throws Exception {
		
//		System.out.println("Initial Leader Host");
//		//new Thread(new leaderElection(REPLICA_MANAGER_NAME)).start();
//		leaderElection le = new leaderElection();
//		String a = le.initialize();
//		System.out.println(a);
		...
		Heart h1 = new Heart("localhost", 5105);
		h1.beat();
		Heart h2 = new Heart("localhost", 5205);
		h2.beat();
		new Heart_Beat_Listener(HEARTBEAT_PORT1, new HeartBeatCallBack() {
			
			public void up() {
				System.out.println("REPLICA " + "replica 2" + " IS UP");
			}
			
			public void down() {
				System.out.println("REPLICA " + "replica 2" + " IS DOWN");
				try {
				//new leaderElection();
				} catch (Exception e) {
					e.printStackTrace();
		...
		new Heart_Beat_Listener(HEARTBEAT_PORT2, new HeartBeatCallBack() {
			...
			public void up() {
				System.out.println("REPLICA " + "replica 3" + " IS UP");
			}
			
			public void down() {
				System.out.println("REPLICA " + "replica 3" + " IS DOWN");
				try {
				//new leaderElection();
				} catch (Exception e) {
					e.printStackTrace();
